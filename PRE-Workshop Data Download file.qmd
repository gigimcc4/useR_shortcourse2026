...
Our dataset is to large to be housed in github or as a file. We can add it as a zip file but after all we are learning how to handle large data in R so...we will do so.

The dataset we are using will take anywhere from 8 to 15 minutes to download.
